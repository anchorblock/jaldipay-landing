            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <a href="mailto:faruk@anchorblock.vc" className="text-sm text-gray-600 hover:text-[#0A3700] transition break-all">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-gray-600">+880 1623000792</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="h-5 w-5 text-[#9EE86F] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
